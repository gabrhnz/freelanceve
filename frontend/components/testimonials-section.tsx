      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 pt-4 md:pt-12">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 leading-[1.3]">
            What our users say
            <br />
            about <span className="bg-[#9945FF] text-white px-3 py-1 inline-block">our platform</span>
          </h2>
          <p className="text-gray-600 text-base md:text-lg max-w-2xl mx-auto pb-8">
            Thousands of freelancers and clients are already using our platform to work together and get paid with USDC on Solana.
          </p>
        </div>
            ...
            <div className="bg-white border-4 border-black rounded-3xl py-8 md:py-14 px-6 md:px-8 md:pr-72 lg:pr-72">
              ...
              <div className="md:max-w-[65%]">
                <p className="text-sm md:text-base lg:text-lg mb-6 leading-relaxed">
                  Finally a freelance platform that pays instantly! I completed a project on Friday and had USDC in my wallet within minutes. No more waiting weeks for international bank transfers. This is the future of freelancing.
                </p>

                <div>
                  <div className="font-bold text-base md:text-lg">Maria Santos</div>
                  <div className="text-gray-600 text-sm md:text-base">Full-Stack Developer from Brazil</div>
                </div>
              </div>
            </div>
